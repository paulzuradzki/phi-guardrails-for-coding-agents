...
CREATE TABLE IF NOT EXISTS inpatient_claims (
    ...
    admtnig_icd9_dgns_cd                 VARCHAR(5),
    clm_pass_thru_per_diem_amt           NUMERIC(12,2),
    nch_bene_ip_ddctbl_amt               NUMERIC(12,2),
    nch_bene_pta_coinsrncl_lblty_amt     NUMERIC(12,2),
    nch_bene_blood_ddctbl_lblty_amt      NUMERIC(12,2),
    clm_utlztion_day_cnt                 VARCHAR(4),
    nch_bene_dschr_g_dt                  VARCHAR(8),
